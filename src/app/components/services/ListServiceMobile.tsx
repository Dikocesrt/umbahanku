export default function ListServiceMobile({ onAdd, onEdit, onDelete }: { onAdd: () => void; onEdit: () => void; onDelete: () => void }) {
    return (
        <div>
                ...
                <div className="flex items-start justify-between mb-3">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <span className="bg-blue-100 text-blue-600 px-2 py-0.5 rounded-full text-xs font-semibold inline-block">
                                Reguler
                            </span>
                        </div>
                    </div>
