export default function AdminsEditModal({ open, onClose }: { open: boolean; onClose: () => void }) {
    if (!open) return null;
        ...
        <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50 p-4">
            <div className="bg-white rounded-2xl w-full max-w-md overflow-hidden">
                ...
                <div className="p-4 md:p-6">
                    ...
                    {/* Input Password */}
                    <div className="mb-3">
                        <label className="block text-sm text-gray-500 font-medium mb-1">Password Baru (Opsional)</label>
                        <input
                            type="password"
                            className="w-full px-3 py-2 text-sm text-gray-700 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-amber-400/30 focus:border-amber-500"
                        ...
                        <div className="grid grid-cols-2 gap-3">
                            <label className="cursor-pointer">
                                ...
                                <div className="border-2 border-gray-200 rounded-xl p-3 text-center transition-all 
                                    ...
                                    <div className="w-10 h-10 mx-auto mb-2 rounded-full bg-green-200 flex items-center justify-center">
