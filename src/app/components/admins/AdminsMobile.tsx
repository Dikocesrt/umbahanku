export default function AdminsMobile({ onAdd, onEdit, onDelete }: { onAdd: () => void, onEdit: () => void, onDelete: () => void }) {
    return (
        <div className="md:hidden space-y-3 rounded-xl p-3 shadow-sm border border-gray-200">
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-4">
                <div className="flex items-start justify-between mb-3">
                    <div>
                        <h3 className="font-semibold text-gray-900">Admin Utama</h3>
                ...
                <div className="grid grid-cols-2 gap-2 text-sm">
                    ...
                    <div>
                        ...
                        <p className="text-gray-700 text-xs">28 Jan 2026</p>
                    </div>
                </div>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-4">
                <div className="flex items-start justify-between mb-3">
                    <div>
                        ...
                        <p className="text-xs text-gray-500">@budi_kasir</p>
                    </div>
                    <div className="flex gap-2">
                ...
                <div className="grid grid-cols-2 gap-2 text-sm">
                    ...
                    <div>
                        <p className="text-gray-500 text-xs">Dibuat</p>
                        <p className="text-gray-700 text-xs">27 Jan 2026</p>
                    </div>
                </div>
            </div>
        </div>
