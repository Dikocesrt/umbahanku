    ...
    return (
        <div className="md:hidden space-y-3 rounded-xl p-3 shadow-sm border border-gray-200">
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-4">
                ...
                <div className="grid grid-cols-2 gap-2 text-sm">
                    <div>
                        ...
                        <p className="text-gray-700 text-xs">admin@umbahanku.com</p>
                    </div>
                    <div>
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-4">
                <div className="flex items-start justify-between mb-3">
                    <div className="flex flex-row items-center gap-2">
                        <h3 className="font-semibold text-gray-900">Budi Kasir</h3>
                ...
                <div className="grid grid-cols-2 gap-2 text-sm">
                    <div>
                        <p className="text-gray-500 text-xs">Email</p>
                        <p className="text-gray-700 text-xs">budi@umbahanku.com</p>
                    </div>
                    <div>
                        <p className="text-gray-500 text-xs">No HP</p>
                        <p className="text-gray-700">081987654321</p>
                    </div>
                    <div className="col-span-2">
                        <p className="text-gray-500 text-xs">Status</p>
                        <span className="bg-green-100 text-green-700 px-2 py-0.5 rounded text-xs font-medium">
